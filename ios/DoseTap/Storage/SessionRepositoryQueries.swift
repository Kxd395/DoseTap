...
public extension SessionRepository {
    ...
    internal func reviewedWindowAssessments(sessionDates: [String]) -> [String: ReviewedWindowAssessment] {
        storage.reviewedWindowAssessments(sessionDates: sessionDates, now: clock())
    }
