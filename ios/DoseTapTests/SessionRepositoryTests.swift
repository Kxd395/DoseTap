...
final class SessionRepositoryTests: XCTestCase {
    ...
    func test_generalMedicationWriteFailureThrowsAndConfirmedDuplicateSurvivesRetry() throws {
        ...
        let reviewed = try repository.medicationDuplicateIDs(medicationId: "adderall_ir", takenAt: now)
        ...
        XCTAssertThrowsError(try repository.logMedicationEntry(medicationId: "adderall_ir", doseMg: 10, takenAt: now, confirmedDuplicate: true, reviewedDuplicateIDs: reviewed))
        ...
        XCTAssertFalse(try repository.logMedicationEntry(medicationId: "adderall_ir", doseMg: 10, takenAt: now, confirmedDuplicate: true, reviewedDuplicateIDs: reviewed).isDuplicate)
