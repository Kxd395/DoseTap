...
This is a delivery plan, not a completed migration. Build 42's fixed defaults remain in place. The independently bounded caffeine-unit correction under DOSETAP-52 can proceed without changing the morning table.
