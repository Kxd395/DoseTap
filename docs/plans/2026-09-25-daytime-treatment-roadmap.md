...
## Initial review findings before build 68

The capture, retry and independent-identity repairs below shipped in slice A;
see its [delivery record](../review/2026-09-25-independent-medication-capture.md).
The diary, nap and export-grain limitations remain.
