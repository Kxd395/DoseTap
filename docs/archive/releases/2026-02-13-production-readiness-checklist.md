...
> Archived on 2026-09-02. This is the 2026-02-13 release snapshot and its test counts and findings are not current. Use `docs/PRODUCTION_READINESS_CHECKLIST.md` for the maintained gate list.
