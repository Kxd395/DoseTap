...
> Archived on 2026-09-02. This is a dated implementation report. Current governance lives in `.specify/memory/constitution.md`, `.github/copilot-instructions.md`, and the repository checks under `tools/`.
