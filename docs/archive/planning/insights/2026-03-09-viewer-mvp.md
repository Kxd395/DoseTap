...
> Archived on 2026-09-02. This is the original product proposal. DoseTap Studio now exists; use `docs/INSIGHTS_STATUS.md` for current implementation and validation status.
