...
> Archived on 2026-09-02. This is the original implementation plan and includes target paths that were not all used. Use `docs/INSIGHTS_STATUS.md` for the live source map and open gates.
