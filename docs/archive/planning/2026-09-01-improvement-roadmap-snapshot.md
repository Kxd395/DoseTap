...
> Archived on 2026-09-02. This long-form roadmap mixes completed history and deferred ideas. Plane is the work tracker; `docs/PLANNING.md` is the maintained repository index.
...
### ⏸️ P2-1: Widget Support — PROPOSAL ONLY
...
**Current disposition:** Prototype WidgetKit source is retained under `proposals/companions/widget`. The 2026-09-01 audit confirmed that there is no Widget Extension target, shared scheme, App Group acceptance, archive evidence, or physical timeline review. The files were removed from the iPhone app source phase, where they had compiled as inert phone-app code rather than a widget.

Activation requirements are canonical in `docs/COMPANION_TARGET_STATUS.md`.

**Effort:** L (target, state architecture, signing, CI, and physical acceptance remain)
...
### ⏸️ P2-3: watchOS Companion — PROPOSAL ONLY

**Problem:** `watchos/` directory had a substantial WatchKit app (ViewModel, WatchConnectivity, UI) but no watch face complications.

**Current disposition:** Prototype watch app and complication source is retained under `proposals/companions/watchos`. No watch application/extension target, shared scheme, signing configuration, CI build, canonical phone-routed mutation path, or physical watch evidence exists. It is not a supported companion.
...
15. ⏸️ P2-1: Widget support proposal retained; no supported extension target
...
**Phase 6 — Platform Expansion ⏸️ DEFERRED**
21. ⏸️ P2-3: watchOS companion proposal retained; no supported target
...
*Status reconciled 2026-09-01: widget and watchOS work is proposal-only pending targets, CI, and physical acceptance. Historical completion counts above do not override `docs/COMPANION_TARGET_STATUS.md`.*
