...
> Archived on 2026-09-02. This monolithic snapshot contains obsolete paths, counts, and component names. Use `docs/architecture/README.md` and the current decision records retained in that folder.

> **Superseded snapshot:** This monolithic 2026-02-16 document is retained for historical context. Current architecture references are indexed by `docs/architecture/README.md`. Use `docs/architecture/07-api-and-networking.md`, `docs/architecture/12-safety-sensitive-legacy-retirement.md`, `docs/architecture/13-component-boundaries.md`, and `docs/SSOT/encryption-at-rest.md` for the maintained boundaries.
