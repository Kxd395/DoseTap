...
> Archived on 2026-09-02. This snapshot contains retired coordinator and undo details. Current medication behavior is defined by `docs/SSOT/README.md` and `docs/SSOT/dose-state-persistence.md`.
