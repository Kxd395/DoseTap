...
> Archived on 2026-09-02. A hand-written function and line-count inventory drifts immediately and is not maintained as current documentation.
...
DoseTapCore.dose1Time (read-only)      — Current Dose 1 time
DoseTapCore.dose2Time (read-only)      — Current Dose 2 time
