...
> Archived on 2026-09-02. Use `docs/TESTING_GUIDE.md` and live test discovery for current coverage.
...
| `APIClientTests.swift` | Supported non-medication endpoints with StubTransport |
