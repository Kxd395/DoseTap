...
> Archived on 2026-09-02. The table inventory in this snapshot drifted. Use `docs/DATABASE_SCHEMA.md` and the schema source named there.
...
The active store uses system SQLite in the application sandbox. No SQLCipher wrapper or database-key lifecycle ships. The exact file-protection attribute is a signed-device evidence gate; see `docs/SSOT/encryption-at-rest.md`.
