...
> Archived on 2026-09-02. This is a point-in-time audit prompt, not a statement of current product behavior. Use `docs/prompt/README.md` for the maintained audit toolkit.
