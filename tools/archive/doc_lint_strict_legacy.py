#!/usr/bin/env python3
# Archived 2026-09-02. This uninvoked checker encoded obsolete file paths and fixed test/event totals.
# Use `bash tools/doc_lint.sh` for the maintained documentation lifecycle and drift checks.
import os
import sys
import re
